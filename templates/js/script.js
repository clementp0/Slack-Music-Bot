...
var users = {
    clement: {
        username: 'Clément Pommerie',
        nameColor: 'white',
        avatar: 'https://ca.slack-edge.com/T3WK391Q9-U6CFAPFD0-6142b3094aa8-512'
    },
    paragon: {
        username: 'Slack Music Bot',
        nameColor: 'white',
        bot: true,
        avatar: 'https://developer.spotify.com/assets/branding-guidelines/icon3@2x.png'
    },
    simon: {
        username: 'Simon Caule',
        nameColor: 'white',
        avatar: 'https://ca.slack-edge.com/T3WK391Q9-UCCJD64AZ-ab46783200bb-512'
    },
    germain: {
        username: 'Germain Grumel',
        nameColor: 'white',
        avatar: 'https://ca.slack-edge.com/T3WK391Q9-U6RPG65PD-7c25c6fdccaa-512'
    }
};
...
var channelData = [{
    ...
    messages: [{
        ...
        embedData: {
            ...
            fields: [{
                ...
                value: '/SMB create {playlistname} '
            }, {
                name: 'Delete Playlist',
                value: '/SMB delete {playlistname} '
            }, {
                name: 'View Playlist Content',
                value: '/SMB view {playlistname}  '
            }, {
                name: 'Show all playlists',
                value: '/SMB show playlists  '
            }, {
                name: 'Add Music to playlist',
                value: '/SMB add {musicname} {playlistname}  '
            }, {
                name: 'Remove Music from playlist',
                value: '/SMB remove {musicname} {playlistname}  '
            },{
                name: 'View all commands',
                value: 'https://github.com/clementp0/Slack-Music-Bot'
            }]
        }
    }]
}, {
    ...
    messages: [{
        type: 'input',
        text: '/SMB add Radical Redemption - Brutal 6.0 Rawstyle',
        user: users.clement
    }, {
        type: 'message',
        delay: 350,
        user: users.paragon,
        text: '[emoji id="2714"] Successfully added Radical Redemption - Brutal 6.0 to Rawstyle',
        embedData: {
            title: '-=-=-=-=-= Music =-=-=-=-=-',
            pill: 'hsl(202, 35%, 68%)',
            thumb: 'https://yt3.ggpht.com/ytc/AAUvwnjj2YJn60Xhk-UDtDFQYKtVrG9DsnnME7fbCO0Wlg=s88-c-k-c0x00ffffff-no-rj',
            fields: [{
                name: 'Title',
                value: 'Radical Redemption - Brutal 6.0'
            }, {
                name: 'Duration',
                value: '00:03:26'
            }, {
            ...
            footer: 'Requested By ' + users.clement.username
        }
    },
    {
        type: 'input',
        text: '/SMB follow Rawstyle',
        user: users.germain
    },{
        type: 'message',
        delay: 350,
        user: users.paragon,
        text: '[emoji id="2665"]' + users.germain.username + ' followed ' + users.clement.username + ' s playlist',
        embedData: {
            title: '-=-=-=-=-= Music =-=-=-=-=-',
            pill: 'hsl(202, 35%, 68%)',
            fields: [{
...
{ name: 'm1_php' },
{ name: 'veille' },
{ name: 'maintenance_ordis' },
{ name: 'longlook-video' },
{ name: 'Direct messages' },
{ name: 'Clément Pommerie' },
{ name: 'Germain Grumel' },
{ name: 'Kevin Canico' },
{ name: 'Hugo Lahaxe' },
{
    ...
    messages: [{
        type: 'input',
        text: 'Tu as vu la derniere vidéo de Sandoz ?? ',
        user: users.clement
    }, {
        type: 'message',
        delay: 1500,
        ...
        text: 'Celle la ?',
        embedData: {
            title: 'https://www.youtube.com/watch?v=_9xInSFBhco',
            pill: 'hsl(202, 35%, 68%)',
            thumb: 'https://yt3.ggpht.com/ytc/AAUvwnj11ZCpZ3JI7fHWSJcLJl0qtCawtJdnSJR23AA84A=s900-c-k-c0x00ffffff-no-rj',
            fields: [{
                name: 'ATTENTION ARNAQUE : LA SÉCURITÉ DU BONCOIN CONTOURNÉE',
                value: 'Sandoz 286 k abonnés'
            }]
        }
    },
    {
        type: 'input',
        text: 'Yes ! Elle est géniale !  ',
        user: users.clement
    },{
        type: 'message',
        delay: 1500,
        user: users.simon,
        text: 'Cest vrai et en parlant du bon coin jai vu une CBF intérrésante !'
    }]
}
];
...
window.addEventListener('load', function () {
    ...
    var app = root.querySelector('.slack-app');
    var elements = {
        root: root,
        app: app,
        invite: '.invite-now',
